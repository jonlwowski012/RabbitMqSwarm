...
sql = "TRUNCATE TABLE clusters_found"
...
def callback(ch, method, properties, body):
	...
	sql = "INSERT INTO clusters_found (x_position, y_position, num_people, time_stamp, people_in_cluster) VALUES (%s, %s, %s, %s, %s)"
	val = (cluster['x_position'], cluster['y_position'],cluster['num_people'],cluster['time_stamp'], cluster['people_in_cluster'])
	mycursor.execute(sql, val)
	mydb.commit()

if __name__ == '__main__':
	# Establish incoming connection from Clusters

...
def callback(ch, method, properties, body):
	...
	sql = "INSERT INTO metaclusters_found (x_position, y_position, num_clusters, time_stamp) VALUES (%s, %s, %s, %s)"
	val = (metacluster['x_position'], metacluster['y_position'],metacluster['num_clusters'],metacluster['time_stamp'])
